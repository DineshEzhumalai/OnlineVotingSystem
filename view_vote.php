<?php include('db_connect.php');
 $pub = "SELECT * FROM `publish`";
 $Sql_query = mysqli_query($conn,$pub);
...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		<div class="row">
			<div class="col-md-12">
			    <div<?php if ($status == "0") echo " style='display: none'; " ; ?> > <a  id="btnview1" class="btn btn-primary btn-sm  col-md-2 float-right" href="voting.php?page=home"  >View Poll</a> </div>
			</div>
		</div>
		<div class="card">
			<div class="card-body">
